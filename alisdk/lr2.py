...
a.LoadBalancerId = "14ab315db23-cn-qingdao-cm5-a01"
a.ListenerPort = 3000
a.BackendServerPort = 30000
a.HealthCheckConnectPort = 30000
a.Bandwidth = -1
a.StickySession = 'off'
a.StickySessionType = 'server'
#a.Cookie = 
...
'''
#close heath check
a= aliyun.api.Slb20140515RemoveBackendServersRequest()
a.LoadBalancerId = "14ab315db23-cn-qingdao-cm5-a01"
a.BackendServers = ["i-28metkvhf"]
try:
	f = a.getResponse()
	if("Code" in f):
		print("失败")
...
a = aliyun.api.Slb20140515SetLoadBalancerHTTPListenerAttributeRequest()
a.LoadBalancerId = "14ab315db23-cn-qingdao-cm5-a01"
a.ListenerPort = 80
a.HealthCheck = 'off'
a.Bandwidth = -1
